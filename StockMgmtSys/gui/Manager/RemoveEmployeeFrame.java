...
public class RemoveEmployeeFrame extends javax.swing.JFrame {
    ...
    public void setEmpId()
    {
        try
        {
            ...
            else
            {
                ...
                for(String id:empId)
                {
                    if(jComboId.getItemAt(c).equals(id)==false)
                        jComboId.addItem(id);
                    c++;
                }
            }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Remove Employees Panel", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 30), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jComboId, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(38, 38, 38))
        );
    ...
    private void jComboIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboIdActionPerformed
         try
        {
            ...
            EmpPojo emp=EmpDao.getRecords(jComboId.getSelectedItem().toString());
            jTxtEmpSalary.setText(String.valueOf(emp.getEmpsal()));
            jTxtEmpName.setText(emp.getEmpname());
            jComboJob.setSelectedItem(emp.getEmptype());
        }
        catch(SQLException e)
        {
    ...
    private void jBtnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnRemoveActionPerformed
        try
        {
            String empid=jComboId.getSelectedItem().toString();
            boolean result=EmpDao.deleteEmp(jComboId.getSelectedItem().toString());
            if(!result)
            {
                JOptionPane.showMessageDialog(null, "Record Not deleted!", "failed!",JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            JOptionPane.showMessageDialog(null, "Record deleted!", "success!",JOptionPane.INFORMATION_MESSAGE);
            jComboId.removeItem(empid);
            setEmpId();
            return;
        }
         catch(SQLException e)
       ...
       {
            JOptionPane.showMessageDialog(null, "No Record Available!", "Empty!",JOptionPane.INFORMATION_MESSAGE);
            e.printStackTrace();
            return;
       }
