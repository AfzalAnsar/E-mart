...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SyockMgmtSys/image/splashscreen1.jpg.png"))); // NOI18N
...
class SplashThread extends Thread
{
    public void run()
    {
        ...
        while(jProgressBar2.getValue()<jProgressBar2.getMaximum())
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "Thread Interruptd!!", "Error!",JOptionPane.ERROR_MESSAGE);
                e.printStackTrace();
                return;
            }
        }
